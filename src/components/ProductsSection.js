...
const productsData = {
  ...
  waterfallsNew:[
    {
      id: 13,
      title: "شلال نجمة (دفع نقطي )",
      code: "WF 014",
      image: "/images/projects/project-12.jpeg", // غيريها لمسار الصورة الفعلي
      description: "شلال شفاف نجمة دفع نقطي يضفي لمسة رائعة للنافورة أو المسبح الخاص بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
    ...
    {
      id: 14,
      title: "شلال وردة  ( دفع نقطي من الاسفل)",
      code: "WF 013",
      image: "/images/projects/project-13.jpeg",
      description: "شلال شفاف وردة دفع نقطي من الاسفل يضفي لمسة رائعة للنافورة أو المسبح الخاص بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    },
    {
      id: 15,
      title: "شلال سداسي (دفع نقطي من الاسفل)",
      code: "WF 012",
      image: "/images/projects/project-14.jpeg",
      description: "شلال شفاف سداسي دفع نقطي من الاسفل يضفي لمسة رائعة للنافورة أو المسبح الخاص بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    },
    {
      id: 16,
      title: "شلال دائري (دفع نقطي من الاسفل)",
      code: "WF 011",
      image: "/images/projects/project-15.jpeg",
      description: "شلال شفاف دائري دفع نقطي من الاسفل يضفي لمسة رائعة للنافورة أو المسبح الخاص بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    },
    {
      id: 17,
      title: "شلال مثلث (دفع نقطي من الاسفل)",
      code: "WF 015",
      image: "/images/projects/project-16.jpeg",
      description: "شلال شفاف مثلث دفع نقطي من الاسفل يضفي لمسة رائعة للنافورة أو المسبح الخاص بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    },
    {
      ...
      description: "شلال شفاف بإضاءة ليد يضفي لمسة رائعة للنافورة أو المسبح الخاصة بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    },
    {
      ...
      description: "شلال مثلث شفاف يضفي لمسة رائعة للنافورة الخاصة بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    },
    {
      ...
      description: "شلال مستطيل شفاف يضفي لمسة رائعة للنافورة الخاصة بك. مصنوع من مادة الأكريليك فايبر الشفاف.",
      features: [
        "مصنوع من مادة الأكريليك فايبر الشفاف"
      ]
    }
  ...
  description: " نافورة شفافة طولية تضفي لمسة رائعة للنافورة أو المسبح الخاص بك . مصنوعة من مادة الأكريليك فايبر الشفاف.",
  features: [
